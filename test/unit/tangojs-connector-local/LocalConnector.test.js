...
describe('LocalConnector', () => {
  ...
  describe('get_device_info', () => {
    it('Should return device state', () => {
      ...
      const info = new tangojs.struct.DeviceInfo({
        name: devname,
        ior: '12345'
      })
  ...
  describe('get_device_property', () => {
    ...
    let prop1 = new tangojs.struct.DbDatum('prop1', 10)
    let prop2 = new tangojs.struct.DbDatum('prop2', {})
  ...
  describe('put_device_property', () => {
    it('Should create / update device property', () => {
      ...
      let prop3 = new tangojs.struct.DbDatum('prop3', 0)
      let properties = { }
  ...
  describe('delete_device_property', () => {
    it('Should delete device property', () => {
      ...
      let properties = {
        prop3: new tangojs.struct.DbDatum('prop3', 0)
      }
  ...
  describe('get_device_attribute_info', () => {
    ...
    let info1 = new tangojs.struct.AttributeInfo({})
    let info2 = new tangojs.struct.AttributeInfo({})
    let info3 = new tangojs.struct.AttributeInfo({})
  ...
  describe('read_device_attribute', () => {
    ...
    let devAttr1 = new tangojs.struct.DeviceAttribute({})
    let devAttr2 = new tangojs.struct.DeviceAttribute({})
  ...
  describe('write_device_attribute', () => {
    ...
    let attrs = {
      attr1: {
        value: new tangojs.struct.DeviceAttribute({name: 'attr1', value: 10}),
        spy: null
      },
      attr2: {
        value: new tangojs.struct.DeviceAttribute({name: 'attr2', value: 11}),
        spy: null
      }
    }
  ...
  describe('device_command_inout', () => {
    ...
    it('Should invoke command with arguments', () => {
      ...
      let arg1 = new tangojs.struct.DeviceData(10)
      let out1 = new tangojs.struct.DeviceData(20)
  ...
  describe('device_command_query', () => {
    it('Should return command info', () => {
      ...
      let info = new tangojs.struct.CommandInfo({})
  ...
  describe('device_command_list_query', () => {
    ...
    let info1 = new tangojs.struct.CommandInfo({})
    let info2 = new tangojs.struct.CommandInfo({})
